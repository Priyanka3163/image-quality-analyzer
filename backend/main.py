...
app = FastAPI(
    title="Image Quality Analysis API",
    version="1.0.0"
)
...
def determine_severity(
    ...
    """
    Determine severity of the detected image-quality issue
    using the extracted image statistics.
    """
...
def calculate_quality_score(
    ...
    """
    Calculate an overall quality score based on
    predicted quality class and issue severity.
    """
...
async def analyze_image(
    ...
    # Check whether OpenCV could actually read it
    if img is None:
        raise HTTPException(
            status_code=400,
